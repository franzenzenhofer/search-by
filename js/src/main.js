...
(function() {
  ...
  $.each([3, 6, 9, 12, 15, 18, 21, 24, 27, 30, 33, 36, 40, 45, 50], function() {
    return $('#sizes').append("<a class='tool size' href='#searchcanvas' data-size='" + this + "' style='background: black; height: " + this + "px; width: " + this + "px;'>&nbsp;</a> ");
  });
